...
const firstdiv = document.getElementById("app");
const questionElement = document.getElementById("question");
const answerButton = document.getElementById("answer-buttons");
const nextButton = document.getElementById("next-btn");
const correct_answer = document.getElementById("check_answer");
const score_board = document.getElementById("center_align");
...
function nextQuestion(){
  ...
  //   firstdiv.style.display = "none";
  //   score_board.style.display = "flex";
  //   score.innerHTML = cal_score; // You can perform further actions when the quiz is completed
   }
}
